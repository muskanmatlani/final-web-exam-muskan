                ...
                <div className="absolute md:h-[617px] h-[626px] inset-[0] justify-center m-auto w-full">
                  ...
                  <div className="absolute bottom-[0] flex flex-col gap-[50px] items-center justify-start right-[18%] w-[57%]">
                    ...
                    <div className="flex flex-col items-center justify-start w-full">
                      <Text className="leading-[90.00px] md:text-5xl text-[90px] text-center text-white-A700_e5 tracking-[-3.00px] w-full">
                        <span className="text-white-A700_e5 font-inter font-semibold">Web</span>
                        <span className="text-gray-300 font-inter font-semibold">3Makr</span>
                        <span className="text-white-A700_e5 font-inter font-semibold"> Redefining How You Create</span>
                      </Text>
                      <Text className="leading-[34.00px] text-3xl sm:text-[26px] md:text-[28px] text-center text-white-A700_b2 tracking-[-0.40px] w-full">
